...
async function getlanguageData() {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Container component="main" maxWidth="xs" style={{width: 'auto', margin: '0',textTransform: 'capitalize',boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px'}}>
        <CssBaseline />
        <Box
          sx={{
            marginTop: 0,
            ...
            <Grid container spacing={2}>
              ...
              >
                ...
                {primaryLang.map(data => (
                  <MenuItem key={data.lang_id} value={data.lang_id} style={{width:"100% !important"}}>
                    {data.lang_desc}
                  </MenuItem>
                ))}
              </Select>
