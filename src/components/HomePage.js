...
function HomePage(props) {
  ...
  return (
    ...
    <Button style={{position:"absolute", margin:'0px', right:'10px',fontSize: "16px", fontWeight: "500", transform: 'translate(0, -100px)'}} onClick={()=>{eventHandlers()}}><BiRefresh/>Reload</Button>
        ...
        props.value.map((img, idx) => (
          <div className={idx === imageIndex ? "slide activeSlide" : "slide"} key={idx}>
             <Card style={{width:"50%",height:"250px",textAlign:"center",margin:"0 auto"}}>
                ...
                <Card.Text>
                    <br></br>
                    Start Date: {img[0].tile_start_date}
                    <br></br>
                ...
                {img[0].event_type_id==2 && gameType==4 &&
                 ...
                 {img[0].event_type_id==2 && gameType==6 &&
                  <NavLink
                  // ImplementCardBoard
                  to="/puzzle" state={{gameAttr:gameAttr,gameData:gameData,eventID:eventID,eventType:eventType,id:id}}  >    
                  <Button id="111" onClick={(e)=>checkSessiosStatus(e)}> Play</Button>
                   </NavLink>
                }
                {img[0].event_type_id==2 && gameType==7 &&
                  <NavLink
                  // ImplementCardBoard
                  to="/scramble" state={{gameAttr:gameAttr,gameData:gameData,eventID:eventID,eventType:eventType,id:id}}  >    
                  <Button id="111" onClick={(e)=>checkSessiosStatus(e)}> Play</Button>
                   </NavLink>
                }
                {img[0].event_type_id==2 && gameType==8 &&
                  <NavLink
                  // ImplementCardBoard
                  to="/electro" state={{gameAttr:gameAttr,gameData:gameData,eventID:eventID,eventType:eventType,id:id}}  >    
                  <Button id="111" onClick={(e)=>checkSessiosStatus(e)}> Play</Button>
                   </NavLink>
                }
                </Card.Body>
