            ...
            this.props.gameAttr.map((data,i) =>
              <div style={{ flex: "0 0 33.3333333%", margin: "2% auto" }} key={i}>
               {data.game.game_type_id == 3 ?
                            ...
                            to="/quiz" state={{gameAttr:data.game,gameData:this.props.gameAttr,eventID:this.props.eventID,eventType:this.props.eventType,id:i}}>
                            ...
                            data.selected != true ? 
                            (<NavLink id={i} onClick={(e)=>this.handleClick(e)} style={{textDecoration: 'none'}}
                            to="/picturePuzzle" state={{gameAttr:data.game,gameData:this.props.gameAttr,eventID:this.props.eventID,eventType:this.props.eventType,id:i}}>
                               <Card  id={i} style={{ textTransform:"capitalize",width:"140px",height:"60px",textAlign:"center",alignItems:"center",display: "inline-grid", backgroundColor: data.selected==true ?'background: rgba(217, 217, 217, 1)': data.lang.lang_color, cursor: data.selected?"default":"pointer" }} >{data.lang.lang_desc}</Card>
                                </NavLink>)
                                :
                                <Card  id={i} style={{ textTransform:"capitalize",width:"140px",height:"60px",textAlign:"center",alignItems:"center",display: "inline-grid", backgroundColor: data.selected == true  ?'background: rgba(217, 217, 217, 1)': data.lang.lang_color, cursor: data.selected?"default":"pointer" }} >{data.lang.lang_desc}</Card>
                                ...
                                data.selected != true ?  
                            (<NavLink id={i} onClick={(e)=>this.handleClick(e)} style={{textDecoration: 'none'}}
                            to="/hangman" state={{gameAttr:data.game,gameData:this.props.gameAttr,eventID:this.props.eventID,eventType:this.props.eventType,id:i}}>
                               <Card  id={i} style={{ textTransform:"capitalize",width:"140px",height:"60px",textAlign:"center",alignItems:"center",display: "inline-grid", backgroundColor: data.selected==true ?'background: rgba(217, 217, 217, 1)': data.lang.lang_color, cursor: data.selected?"default":"pointer" }} >{data.lang.lang_desc}</Card>
                                </NavLink>)
                                :
                                <Card  id={i} style={{ textTransform:"capitalize",width:"140px",height:"60px",textAlign:"center",alignItems:"center",display: "inline-grid", backgroundColor: data.selected == true  ?'background: rgba(217, 217, 217, 1)': data.lang.lang_color, cursor: data.selected?"default":"pointer" }} >{data.lang.lang_desc}</Card>
                                ...
                                data.selected != true ?  
                                (<NavLink id={i} onClick={(e)=>this.handleClick(e)} style={{textDecoration: 'none'}}
                                to="/wordgame" state={{gameAttr:data.game,gameData:this.props.gameAttr,eventID:this.props.eventID,eventType:this.props.eventType,id:i}}>
                                   <Card  id={i} style={{ textTransform:"capitalize",width:"140px",height:"60px",textAlign:"center",alignItems:"center",display: "inline-grid", backgroundColor: data.selected==true ?'background: rgba(217, 217, 217, 1)': data.lang.lang_color, cursor: data.selected?"default":"pointer" }} >{data.lang.lang_desc}</Card>
                                    </NavLink>)
                                    :
                                    <Card  id={i} style={{ textTransform:"capitalize",width:"140px",height:"60px",textAlign:"center",alignItems:"center",display: "inline-grid", backgroundColor: data.selected == true  ?'background: rgba(217, 217, 217, 1)': data.lang.lang_color, cursor: data.selected?"default":"pointer" }} >{data.lang.lang_desc}</Card>
